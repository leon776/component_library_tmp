var yScroller = (function() {
    ...
    Scroller.prototype = {
        ...
        onStart: function (evt) {
            ...
            this.startY = this.y;
            //console.log(this.y);
            var tmp = this.$scroller.style.marginTop;
            this.$scroller.style.webkitTransition = 'all 0s ease';
            this.$scroller.style.marginTop = 0;
            this.$scroller.style.webkitTransform = 'translate3d(0, '+ tmp +', 0)';
        },
        ...
        scrollTo: function (y, duration) {
            ...
            this.slideTimer = window.setTimeout(function() {
                that.isMoving = false;
                that.$scroller.style.marginTop = -y + 'px';
                that.$scroller.style.webkitTransition = 'all 0s ease';
